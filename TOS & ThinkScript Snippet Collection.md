...
- [IF EXPRESSIONS AND STATEMENTS EXPLAINED.....Page 8](#IF_EXPRESSIONS_AND_STATEMENTS_EXPLAINED)
- [CHANGE THE COLORING OF A PLOT BASED ON A CONDITION.....Page 9](#CHANGE_THE_COLORING_OF_A_PLOT_BASED_ON_A_CONDITION)
- [HOW THINKSCRIPT CALCULATES.....Page 10](#HOW_THINKSCRIPT_CALCULATES)
- [COLORS AS USED IN TOS/THINKSCRIPT.....Page 11](#COLORS_AS_USED_IN_TOS_THINKSCRIPT)
- [OFTEN USED COLORING CODE STATEMENTS.....Page 13](#OFTEN_USED_COLORING_CODE_STATEMENTS)
- [IMPLEMENTING LABELS.....Page 14](#IMPLEMENTING_LABELS)
- [AGGREGATION.....Page 16](#AGGREGATION)
- [EXPLANATION OF '=' , '=='AND '!' .....Page 17](#EXPLANATION_OF_EQUAL_EQUALS_AND_NOT)
- [REFERENCING OTHER STUDIES.....Page 17](#REFERENCING_OTHER_STUDIES)
- [B&C-NORMALIZATION.....Page 19](#NORMALIZATION)
- [COUNTING AND USE OF 'COMPOUNDVALUE'.....Page 20](#COUNTING_AND_USE_OF_COMPOUNDVALUE)
- [LINEAR REGRESSION .....Page 20](#LINEAR_REGRESSION)
- [TWO WAYS TO CALCULATE % CHANGE.....Page 21](#TWO_WAYS_TO_CALCULATE_PERCENT_CHANGE)
- [FORMATTING WITH 'AsText', 'AsDollars' AND OTHERS.....Page 22](#FORMATTING_WITH_AsText_AsDollars_AND_OTHERS)
- [LITERAL TEXT IN LABEL FOR THE 11 CHOICES OF INPUT PRICE.....Page 22](#LITERAL_TEXT_IN_LABEL_FOR_THE_11_CHOICES_OF_INPUT_PRICE)
- [WHAT IS SWING-HIGH, SWING-LOW.....Page 23](#WHAT_IS_SWING_HIGH_SWING_LOW)
- [COMPARISON TO ANOTHER INSTRUMENT.....Page 23](#COMPARISON_TO_ANOTHER_INSTRUMENT)
- [THE FOLD FUNCTION EXPLAINED.....Page 24](#THE_FOLD_FUNCTION_EXPLAINED)
- [ACCESSING THE CONDITION WIZARD.....Page 27](#ACCESSING_THE_CONDITION_WIZARD)
- [THE STOCHASTIC OSCILLATOR EXPLAINED.....Page 27](#THE_STOCHASTIC_OSCILLATOR_EXPLAINED)
- [THE STANDAED DEVIATION (SD) EXPLAINED.....Page 27](#THE_STANDAED_DEVIATION_SD_EXPLAINED)
...
- [C&S-FLEXIBLE 200-DAY MOVING AVERAGE PLOT AND SCAN.....Page 115](#FLEXIBLE_200_DAY_MOVING_AVERAGE_PLOT_AND_SCAN)
- [C-HOW TO USE A STUDY-WITHIN-A-STUDY.....Page 116](#HOW_TO_USE_A_STUDY_A_STUDY_WITHIN_A_STUDY)
- [C-AN ALTERED 'PERCENTCHG' TO MAKE IT MORE USEFUL.....Page 116](#AN_ALTERED_PERCENTCHG_TO_MAKE_IT_MORE_USEFUL)
- [C-LINEAR REGRESSION OF THE PROJECTIONBANDS STUDY.....Page 117](#LINEAR_REGRESSION_OF_THE_PROJECTIONBANDS_STUDY)
- [C-CLARIFICATION OF THE FOLLOWING THREE COMPARISON STUDIES.....Page 118](#CLARIFICATION_OF_THE_FOLLOWING_THREE_COMPARISON_STUDIES)
- [C-COMPARISON OF ALL SECTORS OF THE S&P 500 (SPX).....Page 118](#COMPARISON_OF_ALL_SECTORS_OF_THE_SANDP_500_SPX)
- [C-S&P 500 SECTORS RELATIVE TO SPX = 0.....Page 121](#SANDP_500_SECTORS_RELATIVE_TO_SPX_=_0)
- [C-MULTIPLE INSTRUMENTS COMPARISON.....Page 125](#MULTIPLE_INSTRUMENTS_COMPARISON)
- [C-PERCENTAGE PRICE OSCILLATOR (PPO) WITH COMPARISON SYMBOL.....Page 128](#PERCENTAGE_PRICE_OSCILLATOR_PPO_WITH_COMPARISON_SYMBOL)
- [C-DMI OSCILLATOR FOR AN INPUTTED SYMBOL.....Page 128](#DMI_OSCILLATOR_FOR_AN_INPUTTED_SYMBOL)
- [C-'ONEGLANCE', A 13-STUDY DASHBOARD .....Page 129](#ONEGLANCE_A_13)
- [C-'Ichi_TK_Exit_Warning' --AN EARLY ICHIMOKU T-K EXIT STUDY.....Page 143](#ICHI_TK_EXIT_WARNING_)
- [C-'IchiOneGlance'--ALL MAIN ICHIMOKU CRITERIA IN DASHBOARD FORMAT.....Page 146](#ICHIONEGLANCE)
- [C-'Ichi_Signals' -IDENTIFIES ALL MAJOR ICHIMOKU SIGNALS FOR LEARNING OR USE.....Page 150](#ICHI_SIGNALS_)
- [C-AN ICHIMOKU CHART EVALUATION SETUP.....Page 159](#AN_ICHIMOKU_CHART_EVALUATION_SETUP)
- [C-MACD BASED ON HULL MOVING AVERAGE.....Page 160](#MACD_BASED_ON_HULL_MOVING_AVERAGE)
- [C-DMI_OSCILLATOR_SFL_FAV .....Page 162](#DMI_OSCILLATOR_SFL_FAV)
- [C-PolarizedFractalEfficiency_SFL.....Page 164](#POLARIZEDFRACTALEFFICIENCY_SFL)
- [C-Three_X_Oscillator.....Page 165](#THREE_X_OSCILLATOR)
- [C-ONEGLANCE STUDY.....Page 167](#ONEGLANCE_STUDY)
- [C-ICHIONEGLANCE STUDY.....Page 176](#ICHIONEGLANCE_STUDY)
